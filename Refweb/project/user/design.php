...
<html lang="en" dir="ltr">
  <head>
    ...
    <title><?php echo $sitename; ?> | Design</title>
...
<body>
  <div class="sidebar">
    ...
    <ul class="nav-list">
      ...
      <li>
        <a href="design.php" class="active">
          ...
          <div class="projects">
              <div class="card">
                  ...
                  <button class="btn active" onclick="filterSelection('all')"><i class="fas fa-layer-group"></i> All</button>
                            <button class="btn" onclick="filterSelection('illustrations')"><i class='far fa-file-alt'></i> illustrations</button>
                            <button class="btn" onclick="filterSelection('icons')"><i class='fas fa-code'></i> icons</button>
                            <button class="btn" onclick="filterSelection('font')"><i class='fas fa-magic'></i>Font</button>
                            <button class="btn" onclick="filterSelection('color')"><i class='far fa-grin-alt'></i> Colors</button>
                  </div>
...
if($content_creator["sect"] == "design"){
echo'
                    <div class="customer">
                        <div class="info">
