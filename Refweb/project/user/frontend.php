...
<html lang="en" dir="ltr">
  <head>
    ...
    <title><?php echo $sitename; ?> | FrontEnd </title>
...
<body>
  <div class="sidebar">
    ...
    <ul class="nav-list">
      ...
      <li>
        <a href="frontend.php" class="active">
          ...
          <div class="projects">
              <div class="card">
                  <div id="card-header">
                      ...
                      <button class="btn" onclick="filterSelection('html')"><i class='fas fa-code'></i> html</button>
                      <button class="btn" onclick="filterSelection('Css')"><i class='far fa-file-alt'></i> css</button>
                      <button class="btn" onclick="filterSelection('Js')"><i class='fas fa-magic'></i> Js</button>
                  </div>
...
if($content_creator["sect"] == "frontend"){
echo'
                    <div class="customer">
                        <div class="info">
